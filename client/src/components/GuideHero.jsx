    ...
    <div className="px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center min-h-screen">
      <div className="text-center mb-6">
        <h1 className="text-3xl sm:text-5xl md:text-6xl 2xl:text-7xl font-semibold mx-auto leading-[1.2] text-slate-900">
          Grow your tours <br />
          with your <span className="text-sky-500">guide workspace</span>
        </h1>
      ...
      <div className="flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs">
        <button
          ...
          className="bg-sky-400 text-white px-10 py-3 rounded-lg hover:scale-105 active:scale-95 transition cursor-pointer"
        >
          Open Dashboard
        </button>
